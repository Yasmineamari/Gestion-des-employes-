...
public class EvenementController implements Initializable {
   ...
   @FXML
    ...
    @FXML
    private void actioncreerevent(ActionEvent event) throws IOException {
                Stage logp = new Stage();
              idevent.getScene().getWindow().hide();
              
                Parent rootA;
                rootA = FXMLLoader.load(getClass().getResource("/View/CreationEv.fxml"));
                Scene scene = new Scene(rootA);
                logp.setScene(scene);
                logp.setTitle("Creation Evenement ");
                logp.show();
                logp.setResizable(false);
    }

   /* @FXML
    private void tableau(SortEvent<C> event) {
    }*/
